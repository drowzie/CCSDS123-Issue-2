...
uint32_t computeScaledPredicted(uint16_t * sample, int32_t ** weightVector, int64_t * diffVector, int32_t localsum, uint16_t x, uint16_t y, uint16_t z, struct arguments * parameters);
