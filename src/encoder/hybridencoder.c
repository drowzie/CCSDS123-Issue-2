...
int encodeLowEntropy(uint64_t treshold, unsigned long sampleToEncode, unsigned int * totalWrittenBytes, unsigned int * numWrittenBits, FILE * fileToWrite, struct arguments * parameters);
/* 
    END OF HEADER
*/
